...
The following is a set of guidelines for contributing to pytest-rabbitmq. These are just guidelines, not rules, use your best judgment and feel free to propose changes to this document in a pull request.
